...
public class Stream {
	...
	public static void main(String args[]) {
		...
		// 9.ForEachOrdered
		System.out.println("ForEachOrdered:");// it will run parallel threads with order
...
//count occurrence of characters
		...
		System.out.println("Parallelstream:");// it will run parallel threads without order
		nameslist.parallelStream().forEach(x -> System.out.println(x));
		System.out.println("Parallelstream orders:");// it will run parallel threads with order
		nameslist.parallelStream().forEachOrdered(x -> System.out.println(x));

		System.out.println("Sequential:");
		nameslist.stream().forEachOrdered(x -> System.out.println(x));
